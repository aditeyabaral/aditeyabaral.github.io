...
I am a Masters in Computer Science student at `New York University, Courant Institute of Mathematical Sciences`.
...
Previously, I worked as an `Applied Researcher` at [Cisco Webex](https://www.webex.com/) where I fine-tuned `on-prem LLMs` to integrate secure and cost-effective AI solutions with the [Webex AI Assistant](https://www.webex.com/ai-assistant.html). I have also worked as an `Applied Research Scientist Intern` at [Intel](https://www.intel.in/content/www/in/en/homepage.html) Research India, where I was advised by [Dr. Anbumani Subramanian](https://sites.google.com/view/anbumani/) and [Anay Majee](http://anaymajee.me/) to develop `attention mechanisms` for vision, aimed at autonomous driving in unconstrained traffic environments like India. 
...
You can read about my current and my published research on my [projects](/projects/) and [publications](/publications/) pages!
